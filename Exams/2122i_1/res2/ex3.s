...
# -mstv -mtls-direct-seg-refs -mvzeroupper
	...
	.text
	.globl	get_pincfg
	.type	get_pincfg, @function
get_pincfg:
.LFB36:
	.cfi_startproc
	endbr64	
# ex3.c:13:     return config->states[state]->pins[pin].pincfg;
	movslq	%esi, %rsi	# tmp97, state
	movq	8(%rdi,%rsi,8), %rax	# *config_7(D), _1
# ex3.c:13:     return config->states[state]->pins[pin].pincfg;
	movslq	%edx, %rdx	# tmp98, pin
	sal		$3, %rdx	#, tmp93
	addq	(%rax), %rdx	# _1->pins, _5
# ex3.c:13:     return config->states[state]->pins[pin].pincfg;
	movl	4(%rdx), %eax	# _5->pincfg, _5->pincfg
# ex3.c:14: }
	ret	