...
for:                # shift n times
    ...
    # shift right least significant part 
    shr $1, %r10
    jnc no_carry1   # \
...
no_carry1:          # /
    ...
    # shift right most significant part 
    shr $1, %r11
    jnc no_carry2
    or $1, %r9
no_carry2:
    ...
    or %r8, %r11 # least significant carry rotates and goes to most significant part
    or %r9, %r10 # most significant carry rotates and goes to least significant part

    jmp for
for_end:
    movq %r10, (%rdi) # q is for quadword (64-bit value)
    movq %r11, 8(%rdi)
    ret
