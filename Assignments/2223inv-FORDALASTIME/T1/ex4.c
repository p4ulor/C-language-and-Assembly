...
void string_find_substitute(char* string, char* string1, char* string2) {
    ...
    size_t maxResultSize = strlen(string) * strlen(string2);
    ...
    *pResult = '\0';
    memcpy(initPointerString, initPointerResult, maxResultSize); //since the memory allocated for array result will end after this function, we can't just do string = initPointerResult;

    /*
    char* final = malloc(maxResultSize*sizeof(char));
    memcpy(final, initPointerResult, maxResultSize); //since the memory allocated for array result will end after this function, we can't just do string = initPointerResult;
    initPointerString = final;
    */
}
...
int main(){
    ...
    char string2_C[] = "aaa";
    string_find_substitute(string0_C, string1_C, string2_C); //causes 'stack smashing detected'
    ...
    char string1_D[] = "aaa";
    char string2_D[] = "a";
    string_find_substitute(string0_D, string1_D, string2_D); //causes 'stack smashing detected'
    ...
    char string1_E[] = "12";
    char string2_E[] = "0123";
    string_find_substitute(string0_E, string1_E, string2_E); //causes 'stack smashing detected'
    ...
    char string1_F[] = "2";
    char string2_F[] = "123";
    string_find_substitute(string0_F, string1_F, string2_F); //causes 'stack smashing detected'
